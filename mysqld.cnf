...
CREATE USER 'scott'@'192.168.%' IDENTIFIED BY 'tiger';
GRANT EXECUTE, PROCESS, SELECT, SHOW DATABASES, SHOW VIEW, ALTER, ALTER ROUTINE, CREATE, CREATE ROUTINE, CREATE TABLESPACE, CREATE TEMPORARY TABLES, CREATE VIEW, DELETE, DROP, EVENT, INDEX, INSERT, REFERENCES, TRIGGER, UPDATE, CREATE USER, FILE, LOCK TABLES, RELOAD, REPLICATION CLIENT, REPLICATION SLAVE, SHUTDOWN, SUPER  ON . TO 'scott'@'192.168.%' WITH GRANT OPTION;
FLUSH PRIVILEGES;
SHOW GRANTS FOR 'scott'@'192.168.%';
...
-- Encyclopedia, httpen.wikipedia.orgwindex.phptitle=Oracle_Database&oldid=416894489
-- (accessed 20130108).
--
...
--
-- Host localhost
-- Generation Time Jan 08, 2013 at 1102 PM
